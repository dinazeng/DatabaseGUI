...
/**
 * cmpt213.a2.model.Consumable class implements Comparable and describes a Consumable object,
...
public class Consumable implements Comparable<Consumable> {
     ...
     * @return an int: -1 if the this expiry date is before otherwise return 1
     */
    @Override
